...
| D16 | Tên cụm khi duyệt = "<insight gốc> <kiểu>" (user chốt 23/09 15:58). CHỈ khi hai kiểu trong CÙNG lượt trùng tên (casefold+strip) mới chèn nhóm: "<insight gốc> <nhóm> <kiểu>". Không bao giờ hỏi gộp vào cụm vừa tạo trong cùng lượt duyệt | QUYẾT ĐP 18:51 (ĐP-21), user bác được; review M1 |
...
| D19 | Tên cụm (kể cả luật chèn nhóm, so casefold + chuẩn hoá khoảng trắng) CHỐT một lần lúc `ghi_de_xuat` và lưu trong nháp; lúc duyệt KIỂM LẠI va chạm với bảng cụm THẬT ⇒ trùng thì trả hỏi gộp như D13, KHÔNG tự đổi tên | QUYẾT ĐP 00:24 25/09 (ĐP-23); review lượt 2 N6 |
