...
- Functional:
  ...
  - Bảng `thao_tac_duyet(id, chia_lan_id, chu, loai, so_video, chi_tiet_json, luc)`; `loai` ∈ tập đóng: `chap_nhan · duyet_het · duyet_kieu · gop · doi_ten · chuyen · ngoai_chu_de · tra_ve · hoan_tac · xoa_kieu · doi_insight` (`duyet_kieu` thêm 26/09 để tách duyệt một kiểu khỏi "Duyệt tất cả").
