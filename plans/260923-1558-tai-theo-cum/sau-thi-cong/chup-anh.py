...
def mo_du_lieu(db: Path) -> int:
    ...
    for i in range(86):
        ...
        ids.append(vid)
    lon = models_cum.tao_cum(db, NGUOI, "Dance", "Badaboum", "couple")
    cartoon = models_cum.tao_cum(db, NGUOI, "Dance", "Badaboum", "Cartoon")
    nhom = models_cum.tao_cum(db, NGUOI, "Dance", "Badaboum", "nhóm")
    chibi = models_cum.tao_cum(db, NGUOI, "Portrait", "Birthday Virgo", "chibi")
